...
/*   Updated: 2017/02/06 13:47:55 by jlasne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	pwd = getpwuid(sb.st_uid);
	...
	oktime = ft_strnew(ft_strlen(ctime(&sb.st_mtime)) - 10);
	oktime = ft_strsub(ctime(&sb.st_mtime), 4, ft_strlen(ctime(&sb.st_mtime)) - 13);
	printf("%-10s %4d %6s %5s %5lld %s %s\n", "dxxxxxxxxx", sb.st_nlink,
			pwd->pw_name, gr->gr_name, sb.st_size, oktime, str);*/
	/*ft_putstr("Actual : ");
